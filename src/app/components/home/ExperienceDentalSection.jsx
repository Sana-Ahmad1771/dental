    ...
    <div className="relative overflow-hidden w-full py-6">
      ...
      >
        {imageList.map((image, idx) => (
          <div
            key={idx}
            className="relative shrink-0 max-w-full h-[180px] sm:h-[200px] md:h-[260px] lg:h-[300px] w-60 sm:w-[320px] md:w-[400px] xl:w-[450px] flex items-center justify-center"
          >
            <img
              src={image.src}
              alt={image.alt}
              className="max-w-full rounded-xl h-full w-full object-cover object-center"
              loading="lazy"
            />
          </div>
        ))}
...
export default function ExperienceDentalSection() {
  ...
  const gallery = [
    {
      alt: "Dental Room 1",
      src: "/images/dental-room-1.jpg",
    },
    {
      alt: "Dental Room 2",
      src: "/images/dental-room-2.jpg",
    },
    {
      alt: "Dental Room 3",
      src: "/images/dental-room-3.jpg",
    },
    {
      alt: "Smiling Patient",
      src: "/images/smillingpatient-2.jpg",
    },
    {
      alt: "Dental Sink Area",
      src: "/images/dentalsinkarea.jpg",
    },
  ];
