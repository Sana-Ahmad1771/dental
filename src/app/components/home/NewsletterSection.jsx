    ...
    >
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-16 xl:px-24 flex flex-col lg:flex-row items-center justify-between gap-10">
        ...
        <div className="max-w-xl z-10">
          <p className="text-white font-semibold uppercase tracking-widest text-sm mb-3">
            Newsletter
          </p>
          ...
          <form className="flex items-center bg-white/30 border border-white py-1 px-2 rounded-full overflow-hidden w-full max-w-md">
            <input
              type="email"
              placeholder="Email"
