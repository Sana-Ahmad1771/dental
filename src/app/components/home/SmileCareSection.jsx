        ...
        <div className="relative">
          ...
          >
            {services.map((service) => (
              <SwiperSlide
                key={service.id}
                className="w-[280px]! sm:w-[300px]! bg-primary/20 text-secondary rounded-lg overflow-hidden flex flex-col justify-between"
              >
                <div className="p-4">
                ...
                <div className="flex justify-center mt-6 mb-6">
                  <button className="inline-block bg-primary text-white font-semibold px-6 py-2 rounded-full shadow-md hover:bg-secondary hover:text-white transition-all duration-300">
                    {service.btn}
                  </button>
                </div>
              </SwiperSlide>
