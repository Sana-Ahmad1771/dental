...
export default function AboutClinicVariant() {
  ...
  return (
    <section className="relative bg-linear-to-b from-white to-teal-50 py-24 md:py-32 overflow-hidden">
      {/* Decorative Glow */}
      <div className="absolute top-[-100px] left-[-100px] w-[400px] h-[400px] bg-primary/10 blur-3xl rounded-full opacity-50 pointer-events-none" />
      <div className="absolute bottom-[-150px] right-[-150px] w-[400px] h-[400px] bg-accent/10 blur-3xl rounded-full opacity-50 pointer-events-none" />

      <div className="max-w-[1500px] mx-auto px-6 lg:px-16 xl:px-24 flex flex-col lg:flex-row-reverse items-center gap-16 relative z-10">
        ...
        >
          ...
          <button
            onClick={() => setIsOpen(true)}
            className="inline-block bg-accent text-white font-medium px-8 py-3 rounded-full shadow-md border border-transparent hover:bg-primary hover:text-light hover:shadow-xl transition-all duration-300"
          >
            Watch Video
          </button>
        </motion.div>
