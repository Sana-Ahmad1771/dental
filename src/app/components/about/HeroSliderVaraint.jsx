...
const slides = [
  {
    ...
    titleLine1: "Redefining Dental Wellness",
    titleLine2: "Where Comfort Meets Precision",
    desc: "We blend advanced technology with a soothing touch to create confident smiles — personalized care that feels effortless.",
  ...
  },
  {
    ...
    titleLine1: "Elevate Your Smile",
    titleLine2: "with Modern Dentistry",
    desc: "Discover gentle, technology-driven care designed to enhance your confidence and oral health.",
    btnText: "Learn More",
    btnLink: "/about",
    align: "right",
  },
        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={slide.id}>
            <div className="relative w-full h-[calc(100vh-100px)] flex items-center overflow-hidden">
              ...
              {/* ✨ Soft Overlay */}
              <div
                className={`absolute inset-0 backdrop-brightness-[0.55] bg-linear-to-tr from-primary/60 via-accent/30 to-transparent`}
              ></div>
                ...
                <div className="max-w-[1500px] mx-auto px-6 lg:px-16 xl:px-24 flex">
                  ...
                  >
                    ...
                    <motion.p
                      ...
                      className="text-neutral-light/90 text-base sm:text-lg md:text-xl leading-relaxed max-w-[90%]"
                    >
                      {slide.desc}
                    </motion.p>
