...
export default function DentalCareSectionVariant() {
  return (
    <section className="relative w-full py-24 md:py-32 bg-[#f8fbfb] overflow-hidden">
      {/* 🌿 Top Floating Image */}
      <motion.div
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center px-6">
        <motion.span
          ...
          className="text-sm tracking-[0.2em] uppercase text-[#ff8b5f] font-semibold mb-4 inline-block"
        >
        ...
        <motion.h1
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="text-[#222] text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-4"
        >
          Your Smile,{" "}
          <span className="text-[#00b6c9]">Our Commitment</span>
        </motion.h1>
